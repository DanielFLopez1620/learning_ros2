...
#include "std_msgs/msg/float64.hpp"   // Include of standard message for int64
...
class IntPub : public rclcpp::Node
{
  ...
  public:
     ...
     * instance a publisher object for floats by using the 'num_flt64'
     * topic and linking a callback with a timer.
    */
    IntPub() : Node("float64_pub"), count_(0)
    {
        publisher_ = this->create_publisher<std_msgs::msg::Float64>("num_flt64", 10);
